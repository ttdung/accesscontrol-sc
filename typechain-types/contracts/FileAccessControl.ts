...
export interface UpdateProposalEventObject {
  proposalId: string;
  fileId: string;
  oldname: string;
  newname: string;
}
export type UpdateProposalEvent = TypedEvent<
  [string, string, string, string],
  UpdateProposalEventObject
>;

export type UpdateProposalEventFilter = TypedEventFilter<UpdateProposalEvent>;
...
export interface FileAccessControl extends BaseContract {
  ...
  functions: {
    ...
    compare(
      str1: PromiseOrValue<string>,
      str2: PromiseOrValue<string>,
  ...
  filters: {
    ...
    "UpdateProposal(bytes32,bytes32,string,string)"(
      proposalId?: PromiseOrValue<BytesLike> | null,
      fileId?: PromiseOrValue<BytesLike> | null,
      oldname?: null,
      newname?: null
    ): UpdateProposalEventFilter;
    UpdateProposal(
      proposalId?: PromiseOrValue<BytesLike> | null,
      fileId?: PromiseOrValue<BytesLike> | null,
      oldname?: null,
